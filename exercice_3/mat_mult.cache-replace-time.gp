...
# (by Stefan.Manegold@cwi.nl, http://www.cwi.nl/~manegold/)
 ...
 set output './mat_mult.cache-replace-time.ps'
...
#set output './mat_mult.cache-replace-time.gif'
set data style linespoints
set key below
set title './mat_mult.cache-replace-time'
...
'./mat_mult.cache-replace-time.data' using 1:($7-0.000000) title '16' with linespoints lt 1 pt 3 , \
'./mat_mult.cache-replace-time.data' using 1:($13-0.000000) title '8' with linespoints lt 2 pt 4
set nolabel
set noarrow
