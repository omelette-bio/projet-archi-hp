...
set format y '%1.0f'
set format y2 ''
set xrange[3.000000:524288.000000]
#set x2range[3.000000:524288.000000]
set yrange[1.000000:1000.000000]
#set y2range[1.000000:1000.000000]
set grid x2tics
set xtics mirror ('1' 1, '2' 2, '4' 4, '8' 8, '16' 16, '32' 32, '64' 64, '128' 128, '256' 256, '512' 512, '1k' 1024, '2k' 2048, '4k' 4096, '8k' 8192, '16k' 16384, '32k' 32768, '64k' 65536, '128k' 131072, '256k' 262144, '512k' 524288)
set x2tics mirror ('<L1>' 1024)
set y2tics ('(0)' 3.120000, '0.002' 1, '0.02' 10, '0.2' 100, '2' 1000)
set label 1 '(0)  ' at 3.000000,0.000000 right
set arrow 1 from 3.000000,0.000000 to 524288.000000,0.000000 nohead lt 0
...
'resultats.TLB-miss-latency.data' using 1:($7-0.000000) title '8200' with linespoints lt 2 pt 4 , \
'resultats.TLB-miss-latency.data' using 1:($13-0.000000) title '4104' with linespoints lt 3 pt 5 , \
'resultats.TLB-miss-latency.data' using 1:($19-0.000000) title '2056' with linespoints lt 4 pt 6 , \
'resultats.TLB-miss-latency.data' using 1:($25-0.000000) title '1032' with linespoints lt 5 pt 7
set nolabel
set noarrow
